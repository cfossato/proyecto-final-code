...
urlpatterns = [
    ...
    path('HospedajeDetalle/<int:pk>', views.HospedajeDetalle.as_view(), name='Detail'),
    path('HospedajeDetalle/nuevo', views.HospedajeCreacion.as_view(), name='New'),
    path('HospedajeUpdate/editar/<int:pk>', views.HospedajeUpdate.as_view(), name='Edit'),
    path('HospedajeDelete/borrar/<int:pk>', views.HospedajeDelete.as_view(), name='Delete'),
